        ...
        * filled (bool) - If true the arc will be filled otherwise it will just be drawn as an outline.        """        pass    def beginDrawInXray(self, *args, **kwargs):        """        beginDrawInXray() -> self
        ...
        If several meshes are drawn between these two APIs, occlusion order is decided by their specification.        """        pass    def beginDrawable(self, *args, **kwargs):        """        beginDrawable(handleName = 0, isPickable = True) -> self
        ...
        * truncateIfSmaller (bool) - If true and offset+numVerts is less than the pre-existing size of the buffer,
        ...
        Remove a descriptor from the list and delete it.        """        pass    pass    key = 'MColorManagementUtilities'    ourdict = {'MPxComponentConverter': <type 'OpenMayaRender.MPxComponentConverter'>, 'MRenderer': <type 'OpenMayaRender.MRenderer'>, 'MFrameContext': <type 'OpenMayaRender.MFrameContext'>, 'MSamplerStateDesc': <type 'OpenMayaRender.MSamplerStateDesc'>, 'MPxVertexBufferMutator': <type 'OpenMayaRender.MPxVertexBufferMutator'>, 'maya': <module 'maya' from 'C:\Program Files\Autodesk\Maya2016\Python\lib\site-packages\maya\__init__.pyc'>, 'MDepthStencilState': <type 'OpenMayaRender.MDepthStencilState'>, '__file__': 'C:\\Program Files\\Autodesk\\Maya2016\\Python\\lib\\site-packages\\maya\\api\\OpenMayaRender.pyc', 'MShaderManager': <type 'OpenMayaRender.MShaderManager'>, 'MIndexBufferDescriptor': <type 'OpenMayaRender.MIndexBufferDescriptor'>, 'MVertexBuffer': <type 'OpenMayaRender.MVertexBuffer'>, 'MShaderInstance': <type 'OpenMayaRender.MShaderInstance'>, 'MHUDRender': <type 'OpenMayaRender.MHUDRender'>, 'MInitFeedback': <type 'OpenMayaRender.MInitFeedback'>, 'MDepthStencilStateDesc': <type 'OpenMayaRender.MDepthStencilStateDesc'>, 'MPxGeometryOverride': <type 'OpenMayaRender.MPxGeometryOverride'>, 'MPassContext': <type 'OpenMayaRender.MPassContext'>, 'MStateManager': <type 'OpenMayaRender.MStateManager'>, 'MTargetBlendDesc': <type 'OpenMayaRender.MTargetBlendDesc'>, 'MVertexBufferDescriptorList': <type 'OpenMayaRender.MVertexBufferDescriptorList'>, 'MSubSceneContainer': <type 'OpenMayaRender.MSubSceneContainer'>, 'MTexture': <type 'OpenMayaRender.MTexture'>, 'MUserRenderOperation': <type 'OpenMayaRender.MUserRenderOperation'>, 'MIndexBufferDescriptorList': <type 'OpenMayaRender.MIndexBufferDescriptorList'>, 'MVertexBufferArray': <type 'OpenMayaRender.MVertexBufferArray'>, 'MGeometryRequirements': <type 'OpenMayaRender.MGeometryRequirements'>, '__builtins__': {'bytearray': <type 'bytearray'>, 'IndexError': <type 'exceptions.IndexError'>, 'all': <built-in function all>, 'help': Type help() for interactive help, or help(object) for help about object., 'vars': <built-in function vars>, 'SyntaxError': <type 'exceptions.SyntaxError'>, 'unicode': <type 'unicode'>, 'UnicodeDecodeError': <type 'exceptions.UnicodeDecodeError'>, 'memoryview': <type 'memoryview'>, 'isinstance': <built-in function isinstance>, 'copyright': Copyright (c) 2001-2013 Python Software Foundation.
All Rights Reserved.
...
All Rights Reserved., 'NameError': <type 'exceptions.NameError'>, 'BytesWarning': <type 'exceptions.BytesWarning'>, 'dict': <type 'dict'>, 'input': <built-in function input>, 'oct': <built-in function oct>, 'bin': <built-in function bin>, 'SystemExit': <type 'exceptions.SystemExit'>, 'StandardError': <type 'exceptions.StandardError'>, 'format': <built-in function format>, 'repr': <built-in function repr>, 'sorted': <built-in function sorted>, 'False': False, 'RuntimeWarning': <type 'exceptions.RuntimeWarning'>, 'list': <type 'list'>, 'iter': <built-in function iter>, 'reload': <built-in function reload>, 'Warning': <type 'exceptions.Warning'>, '__package__': None, 'round': <built-in function round>, 'dir': <built-in function dir>, 'cmp': <built-in function cmp>, 'set': <type 'set'>, 'bytes': <type 'str'>, 'reduce': <built-in function reduce>, 'intern': <built-in function intern>, 'issubclass': <built-in function issubclass>, 'Ellipsis': Ellipsis, 'EOFError': <type 'exceptions.EOFError'>, 'locals': <built-in function locals>, 'BufferError': <type 'exceptions.BufferError'>, 'slice': <type 'slice'>, 'FloatingPointError': <type 'exceptions.FloatingPointError'>, 'sum': <built-in function sum>, 'getattr': <built-in function getattr>, 'abs': <built-in function abs>, 'exit': Use exit() or Ctrl-Z plus Return to exit, 'print': <built-in function print>, 'True': True, 'FutureWarning': <type 'exceptions.FutureWarning'>, 'ImportWarning': <type 'exceptions.ImportWarning'>, 'None': None, 'hash': <built-in function hash>, 'ReferenceError': <type 'exceptions.ReferenceError'>, 'len': <built-in function len>, 'credits':     Thanks to CWI, CNRI, BeOpen.com, Zope Corporation and a cast of thousands
    for supporting Python development.  See www.python.org for more information., 'frozenset': <type 'frozenset'>, '__name__': '__builtin__', 'ord': <built-in function ord>, 'super': <type 'super'>, 'TypeError': <type 'exceptions.TypeError'>, 'license': See http://www.python.org/2.7/license.html, 'KeyboardInterrupt': <type 'exceptions.KeyboardInterrupt'>, 'UserWarning': <type 'exceptions.UserWarning'>, 'filter': <built-in function filter>, 'range': <built-in function range>, 'staticmethod': <type 'staticmethod'>, 'SystemError': <type 'exceptions.SystemError'>, 'BaseException': <type 'exceptions.BaseException'>, 'pow': <built-in function pow>, 'RuntimeError': <type 'exceptions.RuntimeError'>, 'float': <type 'float'>, 'MemoryError': <type 'exceptions.MemoryError'>, 'StopIteration': <type 'exceptions.StopIteration'>, 'globals': <built-in function globals>, 'divmod': <built-in function divmod>, 'enumerate': <type 'enumerate'>, 'apply': <built-in function apply>, 'LookupError': <type 'exceptions.LookupError'>, 'open': <built-in function open>, 'quit': Use quit() or Ctrl-Z plus Return to exit, 'basestring': <type 'basestring'>, 'UnicodeError': <type 'exceptions.UnicodeError'>, 'zip': <built-in function zip>, 'hex': <built-in function hex>, 'long': <type 'long'>, 'next': <built-in function next>, 'ImportError': <type 'exceptions.ImportError'>, 'chr': <built-in function chr>, 'xrange': <type 'xrange'>, 'type': <type 'type'>, '__doc__': "Built-in functions, exceptions, and other objects.\n\nNoteworthy: None is the `nil' object; Ellipsis represents `...' in slices.", 'Exception': <type 'exceptions.Exception'>, 'tuple': <type 'tuple'>, 'UnicodeTranslateError': <type 'exceptions.UnicodeTranslateError'>, 'reversed': <type 'reversed'>, 'UnicodeEncodeError': <type 'exceptions.UnicodeEncodeError'>, 'IOError': <type 'exceptions.IOError'>, 'hasattr': <built-in function hasattr>, 'delattr': <built-in function delattr>, 'setattr': <built-in function setattr>, 'raw_input': <built-in function raw_input>, 'SyntaxWarning': <type 'exceptions.SyntaxWarning'>, 'compile': <built-in function compile>, 'ArithmeticError': <type 'exceptions.ArithmeticError'>, 'str': <type 'str'>, 'property': <type 'property'>, 'GeneratorExit': <type 'exceptions.GeneratorExit'>, 'int': <type 'int'>, '__import__': <built-in function __import__>, 'KeyError': <type 'exceptions.KeyError'>, 'coerce': <built-in function coerce>, 'PendingDeprecationWarning': <type 'exceptions.PendingDeprecationWarning'>, 'file': <type 'file'>, 'EnvironmentError': <type 'exceptions.EnvironmentError'>, 'unichr': <built-in function unichr>, 'id': <built-in function id>, 'OSError': <type 'exceptions.OSError'>, 'DeprecationWarning': <type 'exceptions.DeprecationWarning'>, 'min': <built-in function min>, 'UnicodeWarning': <type 'exceptions.UnicodeWarning'>, 'execfile': <built-in function execfile>, 'any': <built-in function any>, 'complex': <type 'complex'>, 'bool': <type 'bool'>, 'ValueError': <type 'exceptions.ValueError'>, 'NotImplemented': NotImplemented, 'map': <built-in function map>, 'buffer': <type 'buffer'>, 'max': <built-in function max>, 'object': <type 'object'>, 'TabError': <type 'exceptions.TabError'>, 'callable': <built-in function callable>, 'ZeroDivisionError': <type 'exceptions.ZeroDivisionError'>, 'eval': <built-in function eval>, '__debug__': True, 'IndentationError': <type 'exceptions.IndentationError'>, 'AssertionError': <type 'exceptions.AssertionError'>, 'classmethod': <type 'classmethod'>, 'UnboundLocalError': <type 'exceptions.UnboundLocalError'>, 'NotImplementedError': <type 'exceptions.NotImplementedError'>, 'AttributeError': <type 'exceptions.AttributeError'>, 'OverflowError': <type 'exceptions.OverflowError'>, 'WindowsError': <type 'exceptions.WindowsError'>}, 'MClearOperation': <type 'OpenMayaRender.MClearOperation'>, 'MGeometryUtilities': <type 'OpenMayaRender.MGeometryUtilities'>, 'MRasterizerStateDesc': <type 'OpenMayaRender.MRasterizerStateDesc'>, 'MRenderItemList': <type 'OpenMayaRender.MRenderItemList'>, 'MTextureManager': <type 'OpenMayaRender.MTextureManager'>, 'MGeometryExtractor': <type 'OpenMayaRender.MGeometryExtractor'>, 'MPxShadingNodeOverride': <type 'OpenMayaRender.MPxShadingNodeOverride'>, 'key': 'MColorManagementUtilities', 'MRenderOperation': <type 'OpenMayaRender.MRenderOperation'>, '__name__': 'maya.api.OpenMayaRender', 'MRenderTargetManager': <type 'OpenMayaRender.MRenderTargetManager'>, 'MGeometryIndexMapping': <type 'OpenMayaRender.MGeometryIndexMapping'>, 'MPxSurfaceShadingNodeOverride': <type 'OpenMayaRender.MPxSurfaceShadingNodeOverride'>, 'MBlendState': <type 'OpenMayaRender.MBlendState'>, 'MDepthNormalizationDescription': <type 'OpenMayaRender.MDepthNormalizationDescription'>, 'MColorManagementUtilities': <type 'OpenMayaRender.MColorManagementUtilities'>, 'MRenderTarget': <type 'OpenMayaRender.MRenderTarget'>, 'MVertexBufferDescriptor': <type 'OpenMayaRender.MVertexBufferDescriptor'>, 'MPxPrimitiveGenerator': <type 'OpenMayaRender.MPxPrimitiveGenerator'>, 'MPxVertexBufferGenerator': <type 'OpenMayaRender.MPxVertexBufferGenerator'>, 'val': <type 'OpenMayaRender.MColorManagementUtilities'>, 'MTextureUpdateRegion': <type 'OpenMayaRender.MTextureUpdateRegion'>, 'MTextureDescription': <type 'OpenMayaRender.MTextureDescription'>, 'py2dict': {'MRenderUtilities': <type 'OpenMayaRender.MRenderUtilities'>, 'MDepthStencilStateDesc': <type 'OpenMayaRender.MDepthStencilStateDesc'>, 'MSelectionInfo': <type 'OpenMayaRender.MSelectionInfo'>, 'MUserRenderOperation': <type 'OpenMayaRender.MUserRenderOperation'>, 'MPxGeometryOverride': <type 'OpenMayaRender.MPxGeometryOverride'>, 'MRenderTarget': <type 'OpenMayaRender.MRenderTarget'>, 'MComponentDataIndexingList': <type 'OpenMayaRender.MComponentDataIndexingList'>, 'MTextureDescription': <type 'OpenMayaRender.MTextureDescription'>, 'MPassContext': <type 'OpenMayaRender.MPassContext'>, 'MVertexBufferDescriptor': <type 'OpenMayaRender.MVertexBufferDescriptor'>, 'MPxPrimitiveGenerator': <type 'OpenMayaRender.MPxPrimitiveGenerator'>, 'MSamplerState': <type 'OpenMayaRender.MSamplerState'>, 'MRenderTargetDescription': <type 'OpenMayaRender.MRenderTargetDescription'>, 'MSubSceneContainerIterator': <type 'OpenMayaRender.MSubSceneContainerIterator'>, 'MPxVertexBufferMutator': <type 'OpenMayaRender.MPxVertexBufferMutator'>, 'MTargetBlendDesc': <type 'OpenMayaRender.MTargetBlendDesc'>, 'MVertexBufferDescriptorList': <type 'OpenMayaRender.MVertexBufferDescriptorList'>, 'MSubSceneContainer': <type 'OpenMayaRender.MSubSceneContainer'>, 'MComponentDataIndexing': <type 'OpenMayaRender.MComponentDataIndexing'>, 'MTexture': <type 'OpenMayaRender.MTexture'>, 'MRenderItem': <type 'OpenMayaRender.MRenderItem'>, 'MPxVertexBufferGenerator': <type 'OpenMayaRender.MPxVertexBufferGenerator'>, 'MStencilOpDesc': <type 'OpenMayaRender.MStencilOpDesc'>, 'MIndexBufferDescriptorList': <type 'OpenMayaRender.MIndexBufferDescriptorList'>, 'MShaderInstance': <type 'OpenMayaRender.MShaderInstance'>, 'MPxComponentConverter': <type 'OpenMayaRender.MPxComponentConverter'>, 'MBlendStateDesc': <type 'OpenMayaRender.MBlendStateDesc'>, 'MVertexBufferArray': <type 'OpenMayaRender.MVertexBufferArray'>, 'MRasterizerState': <type 'OpenMayaRender.MRasterizerState'>, 'MTextureUpdateRegion': <type 'OpenMayaRender.MTextureUpdateRegion'>, 'MSwatchRenderBase': <type 'OpenMayaRender.MSwatchRenderBase'>, 'MGeometryRequirements': <type 'OpenMayaRender.MGeometryRequirements'>, '__package__': None, 'MClearOperation': <type 'OpenMayaRender.MClearOperation'>, 'MCameraOverride': <type 'OpenMayaRender.MCameraOverride'>, 'MDepthStencilState': <type 'OpenMayaRender.MDepthStencilState'>, 'MFrameContext': <type 'OpenMayaRender.MFrameContext'>, 'MGeometryUtilities': <type 'OpenMayaRender.MGeometryUtilities'>, 'MFragmentManager': <type 'OpenMayaRender.MFragmentManager'>, 'MSamplerStateDesc': <type 'OpenMayaRender.MSamplerStateDesc'>, 'MIndexBuffer': <type 'OpenMayaRender.MIndexBuffer'>, 'MRasterizerStateDesc': <type 'OpenMayaRender.MRasterizerStateDesc'>, 'MDepthNormalizationDescription': <type 'OpenMayaRender.MDepthNormalizationDescription'>, 'MUIDrawManager': <type 'OpenMayaUI.MUIDrawManager'>, 'MRenderItemList': <type 'OpenMayaRender.MRenderItemList'>, 'MHUDRender': <type 'OpenMayaRender.MHUDRender'>, 'MShaderCompileMacro': <type 'OpenMayaRender.MShaderCompileMacro'>, 'MRenderer': <type 'OpenMayaRender.MRenderer'>, 'MTextureManager': <type 'OpenMayaRender.MTextureManager'>, 'MGeometryExtractor': <type 'OpenMayaRender.MGeometryExtractor'>, 'MSceneRender': <type 'OpenMayaRender.MSceneRender'>, 'MInitFeedback': <type 'OpenMayaRender.MInitFeedback'>, 'MShaderManager': <type 'OpenMayaRender.MShaderManager'>, 'MPxShaderOverride': <type 'OpenMayaRender.MPxShaderOverride'>, 'MPxDrawOverride': <type 'OpenMayaRender.MPxDrawOverride'>, 'MAttributeParameterMappingList': <type 'OpenMayaRender.MAttributeParameterMappingList'>, 'MQuadRender': <type 'OpenMayaRender.MQuadRender'>, '__file__': 'C:\\Program Files\\Autodesk\\Maya2016\\Python\\lib\\site-packages\\maya\\api\\_OpenMayaRender_py2.pyd', 'MRenderOverride': <type 'OpenMayaRender.MRenderOverride'>, 'MRenderOperation': <type 'OpenMayaRender.MRenderOperation'>, '__name__': 'maya.api._OpenMayaRender_py2', 'MRenderTargetManager': <type 'OpenMayaRender.MRenderTargetManager'>, 'MGeometry': <type 'OpenMayaRender.MGeometry'>, 'MIndexBufferDescriptor': <type 'OpenMayaRender.MIndexBufferDescriptor'>, 'MStateManager': <type 'OpenMayaRender.MStateManager'>, 'MGeometryIndexMapping': <type 'OpenMayaRender.MGeometryIndexMapping'>, 'MPxIndexBufferMutator': <type 'OpenMayaRender.MPxIndexBufferMutator'>, 'MPxSurfaceShadingNodeOverride': <type 'OpenMayaRender.MPxSurfaceShadingNodeOverride'>, 'MVertexBuffer': <type 'OpenMayaRender.MVertexBuffer'>, 'MBlendState': <type 'OpenMayaRender.MBlendState'>, 'MLightParameterInformation': <type 'OpenMayaRender.MLightParameterInformation'>, '__doc__': 'OpenMayaRender base API.', 'MPxSubSceneOverride': <type 'OpenMayaRender.MPxSubSceneOverride'>, 'MAttributeParameterMapping': <type 'OpenMayaRender.MAttributeParameterMapping'>, 'MIntersection': <type 'OpenMayaRender.MIntersection'>, 'MInitContext': <type 'OpenMayaRender.MInitContext'>, 'MSelectionContext': <type 'OpenMayaRender.MSelectionContext'>, 'MPxShadingNodeOverride': <type 'OpenMayaRender.MPxShadingNodeOverride'>, 'MDrawRegistry': <type 'OpenMayaRender.MDrawRegistry'>, 'MDrawContext': <type 'OpenMayaRender.MDrawContext'>, 'MPresentTarget': <type 'OpenMayaRender.MPresentTarget'>, 'MColorManagementUtilities': <type 'OpenMayaRender.MColorManagementUtilities'>}, 'MRenderUtilities': <type 'OpenMayaRender.MRenderUtilities'>, 'MShaderCompileMacro': <type 'OpenMayaRender.MShaderCompileMacro'>, '__doc__': None, 'ourdict': {...}, 'MPxShaderOverride': <type 'OpenMayaRender.MPxShaderOverride'>, 'MPxDrawOverride': <type 'OpenMayaRender.MPxDrawOverride'>, 'MAttributeParameterMappingList': <type 'OpenMayaRender.MAttributeParameterMappingList'>, 'MUIDrawManager': <type 'OpenMayaUI.MUIDrawManager'>, 'MAttributeParameterMapping': <type 'OpenMayaRender.MAttributeParameterMapping'>, 'MIndexBuffer': <type 'OpenMayaRender.MIndexBuffer'>, 'MInitContext': <type 'OpenMayaRender.MInitContext'>, 'MRenderTargetDescription': <type 'OpenMayaRender.MRenderTargetDescription'>, 'MPresentTarget': <type 'OpenMayaRender.MPresentTarget'>, 'MSelectionInfo': <type 'OpenMayaRender.MSelectionInfo'>, 'MComponentDataIndexingList': <type 'OpenMayaRender.MComponentDataIndexingList'>, 'MRenderOverride': <type 'OpenMayaRender.MRenderOverride'>, 'MSubSceneContainerIterator': <type 'OpenMayaRender.MSubSceneContainerIterator'>, 'MSceneRender': <type 'OpenMayaRender.MSceneRender'>, 'MComponentDataIndexing': <type 'OpenMayaRender.MComponentDataIndexing'>, 'MStencilOpDesc': <type 'OpenMayaRender.MStencilOpDesc'>, 'MBlendStateDesc': <type 'OpenMayaRender.MBlendStateDesc'>, 'MSwatchRenderBase': <type 'OpenMayaRender.MSwatchRenderBase'>, '__package__': 'maya.api', 'MCameraOverride': <type 'OpenMayaRender.MCameraOverride'>, 'MFragmentManager': <type 'OpenMayaRender.MFragmentManager'>, 'MSamplerState': <type 'OpenMayaRender.MSamplerState'>, 'MQuadRender': <type 'OpenMayaRender.MQuadRender'>, 'MGeometry': <type 'OpenMayaRender.MGeometry'>, 'MPxIndexBufferMutator': <type 'OpenMayaRender.MPxIndexBufferMutator'>, 'MLightParameterInformation': <type 'OpenMayaRender.MLightParameterInformation'>, 'MRenderItem': <type 'OpenMayaRender.MRenderItem'>, 'MPxSubSceneOverride': <type 'OpenMayaRender.MPxSubSceneOverride'>, 'MRasterizerState': <type 'OpenMayaRender.MRasterizerState'>, 'MIntersection': <type 'OpenMayaRender.MIntersection'>, 'MSelectionContext': <type 'OpenMayaRender.MSelectionContext'>, 'MDrawRegistry': <type 'OpenMayaRender.MDrawRegistry'>, 'MDrawContext': <type 'OpenMayaRender.MDrawContext'>}    py2dict = {'MRenderUtilities': <type 'OpenMayaRender.MRenderUtilities'>, 'MDepthStencilStateDesc': <type 'OpenMayaRender.MDepthStencilStateDesc'>, 'MSelectionInfo': <type 'OpenMayaRender.MSelectionInfo'>, 'MUserRenderOperation': <type 'OpenMayaRender.MUserRenderOperation'>, 'MPxGeometryOverride': <type 'OpenMayaRender.MPxGeometryOverride'>, 'MRenderTarget': <type 'OpenMayaRender.MRenderTarget'>, 'MComponentDataIndexingList': <type 'OpenMayaRender.MComponentDataIndexingList'>, 'MTextureDescription': <type 'OpenMayaRender.MTextureDescription'>, 'MPassContext': <type 'OpenMayaRender.MPassContext'>, 'MVertexBufferDescriptor': <type 'OpenMayaRender.MVertexBufferDescriptor'>, 'MPxPrimitiveGenerator': <type 'OpenMayaRender.MPxPrimitiveGenerator'>, 'MSamplerState': <type 'OpenMayaRender.MSamplerState'>, 'MRenderTargetDescription': <type 'OpenMayaRender.MRenderTargetDescription'>, 'MSubSceneContainerIterator': <type 'OpenMayaRender.MSubSceneContainerIterator'>, 'MPxVertexBufferMutator': <type 'OpenMayaRender.MPxVertexBufferMutator'>, 'MTargetBlendDesc': <type 'OpenMayaRender.MTargetBlendDesc'>, 'MVertexBufferDescriptorList': <type 'OpenMayaRender.MVertexBufferDescriptorList'>, 'MSubSceneContainer': <type 'OpenMayaRender.MSubSceneContainer'>, 'MComponentDataIndexing': <type 'OpenMayaRender.MComponentDataIndexing'>, 'MTexture': <type 'OpenMayaRender.MTexture'>, 'MRenderItem': <type 'OpenMayaRender.MRenderItem'>, 'MPxVertexBufferGenerator': <type 'OpenMayaRender.MPxVertexBufferGenerator'>, 'MStencilOpDesc': <type 'OpenMayaRender.MStencilOpDesc'>, 'MIndexBufferDescriptorList': <type 'OpenMayaRender.MIndexBufferDescriptorList'>, 'MShaderInstance': <type 'OpenMayaRender.MShaderInstance'>, 'MPxComponentConverter': <type 'OpenMayaRender.MPxComponentConverter'>, 'MBlendStateDesc': <type 'OpenMayaRender.MBlendStateDesc'>, 'MVertexBufferArray': <type 'OpenMayaRender.MVertexBufferArray'>, 'MRasterizerState': <type 'OpenMayaRender.MRasterizerState'>, 'MTextureUpdateRegion': <type 'OpenMayaRender.MTextureUpdateRegion'>, 'MSwatchRenderBase': <type 'OpenMayaRender.MSwatchRenderBase'>, 'MGeometryRequirements': <type 'OpenMayaRender.MGeometryRequirements'>, '__package__': None, 'MClearOperation': <type 'OpenMayaRender.MClearOperation'>, 'MCameraOverride': <type 'OpenMayaRender.MCameraOverride'>, 'MDepthStencilState': <type 'OpenMayaRender.MDepthStencilState'>, 'MFrameContext': <type 'OpenMayaRender.MFrameContext'>, 'MGeometryUtilities': <type 'OpenMayaRender.MGeometryUtilities'>, 'MFragmentManager': <type 'OpenMayaRender.MFragmentManager'>, 'MSamplerStateDesc': <type 'OpenMayaRender.MSamplerStateDesc'>, 'MIndexBuffer': <type 'OpenMayaRender.MIndexBuffer'>, 'MRasterizerStateDesc': <type 'OpenMayaRender.MRasterizerStateDesc'>, 'MDepthNormalizationDescription': <type 'OpenMayaRender.MDepthNormalizationDescription'>, 'MUIDrawManager': <type 'OpenMayaUI.MUIDrawManager'>, 'MRenderItemList': <type 'OpenMayaRender.MRenderItemList'>, 'MHUDRender': <type 'OpenMayaRender.MHUDRender'>, 'MShaderCompileMacro': <type 'OpenMayaRender.MShaderCompileMacro'>, 'MRenderer': <type 'OpenMayaRender.MRenderer'>, 'MTextureManager': <type 'OpenMayaRender.MTextureManager'>, 'MGeometryExtractor': <type 'OpenMayaRender.MGeometryExtractor'>, 'MSceneRender': <type 'OpenMayaRender.MSceneRender'>, 'MInitFeedback': <type 'OpenMayaRender.MInitFeedback'>, 'MShaderManager': <type 'OpenMayaRender.MShaderManager'>, 'MPxShaderOverride': <type 'OpenMayaRender.MPxShaderOverride'>, 'MPxDrawOverride': <type 'OpenMayaRender.MPxDrawOverride'>, 'MAttributeParameterMappingList': <type 'OpenMayaRender.MAttributeParameterMappingList'>, 'MQuadRender': <type 'OpenMayaRender.MQuadRender'>, '__file__': 'C:\\Program Files\\Autodesk\\Maya2016\\Python\\lib\\site-packages\\maya\\api\\_OpenMayaRender_py2.pyd', 'MRenderOverride': <type 'OpenMayaRender.MRenderOverride'>, 'MRenderOperation': <type 'OpenMayaRender.MRenderOperation'>, '__name__': 'maya.api._OpenMayaRender_py2', 'MRenderTargetManager': <type 'OpenMayaRender.MRenderTargetManager'>, 'MGeometry': <type 'OpenMayaRender.MGeometry'>, 'MIndexBufferDescriptor': <type 'OpenMayaRender.MIndexBufferDescriptor'>, 'MStateManager': <type 'OpenMayaRender.MStateManager'>, 'MGeometryIndexMapping': <type 'OpenMayaRender.MGeometryIndexMapping'>, 'MPxIndexBufferMutator': <type 'OpenMayaRender.MPxIndexBufferMutator'>, 'MPxSurfaceShadingNodeOverride': <type 'OpenMayaRender.MPxSurfaceShadingNodeOverride'>, 'MVertexBuffer': <type 'OpenMayaRender.MVertexBuffer'>, 'MBlendState': <type 'OpenMayaRender.MBlendState'>, 'MLightParameterInformation': <type 'OpenMayaRender.MLightParameterInformation'>, '__doc__': 'OpenMayaRender base API.', 'MPxSubSceneOverride': <type 'OpenMayaRender.MPxSubSceneOverride'>, 'MAttributeParameterMapping': <type 'OpenMayaRender.MAttributeParameterMapping'>, 'MIntersection': <type 'OpenMayaRender.MIntersection'>, 'MInitContext': <type 'OpenMayaRender.MInitContext'>, 'MSelectionContext': <type 'OpenMayaRender.MSelectionContext'>, 'MPxShadingNodeOverride': <type 'OpenMayaRender.MPxShadingNodeOverride'>, 'MDrawRegistry': <type 'OpenMayaRender.MDrawRegistry'>, 'MDrawContext': <type 'OpenMayaRender.MDrawContext'>, 'MPresentTarget': <type 'OpenMayaRender.MPresentTarget'>, 'MColorManagementUtilities': <type 'OpenMayaRender.MColorManagementUtilities'>}class val(object):    """    Utilities class for color management    """    def __init__(self, *args, **kwargs):        """        x.__init__(...) initializes x; see help(type(x)) for signature        """        pass    def getColorTransformCacheIdForInputSpace(*args, **kwargs):        """        getColorTransformCacheIdForInputSpace(inputSpaceName) -> transformId
