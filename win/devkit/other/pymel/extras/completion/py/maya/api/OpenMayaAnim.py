...
All Rights Reserved., 'NameError': <type 'exceptions.NameError'>, 'BytesWarning': <type 'exceptions.BytesWarning'>, 'dict': <type 'dict'>, 'input': <built-in function input>, 'oct': <built-in function oct>, 'bin': <built-in function bin>, 'SystemExit': <type 'exceptions.SystemExit'>, 'StandardError': <type 'exceptions.StandardError'>, 'format': <built-in function format>, 'repr': <built-in function repr>, 'sorted': <built-in function sorted>, 'False': False, 'RuntimeWarning': <type 'exceptions.RuntimeWarning'>, 'list': <type 'list'>, 'iter': <built-in function iter>, 'reload': <built-in function reload>, 'Warning': <type 'exceptions.Warning'>, '__package__': None, 'round': <built-in function round>, 'dir': <built-in function dir>, 'cmp': <built-in function cmp>, 'set': <type 'set'>, 'bytes': <type 'str'>, 'reduce': <built-in function reduce>, 'intern': <built-in function intern>, 'issubclass': <built-in function issubclass>, 'Ellipsis': Ellipsis, 'EOFError': <type 'exceptions.EOFError'>, 'locals': <built-in function locals>, 'BufferError': <type 'exceptions.BufferError'>, 'slice': <type 'slice'>, 'FloatingPointError': <type 'exceptions.FloatingPointError'>, 'sum': <built-in function sum>, 'getattr': <built-in function getattr>, 'abs': <built-in function abs>, 'exit': Use exit() or Ctrl-Z plus Return to exit, 'print': <built-in function print>, 'True': True, 'FutureWarning': <type 'exceptions.FutureWarning'>, 'ImportWarning': <type 'exceptions.ImportWarning'>, 'None': None, 'hash': <built-in function hash>, 'ReferenceError': <type 'exceptions.ReferenceError'>, 'len': <built-in function len>, 'credits':     Thanks to CWI, CNRI, BeOpen.com, Zope Corporation and a cast of thousands
    for supporting Python development.  See www.python.org for more information., 'frozenset': <type 'frozenset'>, '__name__': '__builtin__', 'ord': <built-in function ord>, 'super': <type 'super'>, 'TypeError': <type 'exceptions.TypeError'>, 'license': See http://www.python.org/2.7/license.html, 'KeyboardInterrupt': <type 'exceptions.KeyboardInterrupt'>, 'UserWarning': <type 'exceptions.UserWarning'>, 'filter': <built-in function filter>, 'range': <built-in function range>, 'staticmethod': <type 'staticmethod'>, 'SystemError': <type 'exceptions.SystemError'>, 'BaseException': <type 'exceptions.BaseException'>, 'pow': <built-in function pow>, 'RuntimeError': <type 'exceptions.RuntimeError'>, 'float': <type 'float'>, 'MemoryError': <type 'exceptions.MemoryError'>, 'StopIteration': <type 'exceptions.StopIteration'>, 'globals': <built-in function globals>, 'divmod': <built-in function divmod>, 'enumerate': <type 'enumerate'>, 'apply': <built-in function apply>, 'LookupError': <type 'exceptions.LookupError'>, 'open': <built-in function open>, 'quit': Use quit() or Ctrl-Z plus Return to exit, 'basestring': <type 'basestring'>, 'UnicodeError': <type 'exceptions.UnicodeError'>, 'zip': <built-in function zip>, 'hex': <built-in function hex>, 'long': <type 'long'>, 'next': <built-in function next>, 'ImportError': <type 'exceptions.ImportError'>, 'chr': <built-in function chr>, 'xrange': <type 'xrange'>, 'type': <type 'type'>, '__doc__': "Built-in functions, exceptions, and other objects.\n\nNoteworthy: None is the `nil' object; Ellipsis represents `...' in slices.", 'Exception': <type 'exceptions.Exception'>, 'tuple': <type 'tuple'>, 'UnicodeTranslateError': <type 'exceptions.UnicodeTranslateError'>, 'reversed': <type 'reversed'>, 'UnicodeEncodeError': <type 'exceptions.UnicodeEncodeError'>, 'IOError': <type 'exceptions.IOError'>, 'hasattr': <built-in function hasattr>, 'delattr': <built-in function delattr>, 'setattr': <built-in function setattr>, 'raw_input': <built-in function raw_input>, 'SyntaxWarning': <type 'exceptions.SyntaxWarning'>, 'compile': <built-in function compile>, 'ArithmeticError': <type 'exceptions.ArithmeticError'>, 'str': <type 'str'>, 'property': <type 'property'>, 'GeneratorExit': <type 'exceptions.GeneratorExit'>, 'int': <type 'int'>, '__import__': <built-in function __import__>, 'KeyError': <type 'exceptions.KeyError'>, 'coerce': <built-in function coerce>, 'PendingDeprecationWarning': <type 'exceptions.PendingDeprecationWarning'>, 'file': <type 'file'>, 'EnvironmentError': <type 'exceptions.EnvironmentError'>, 'unichr': <built-in function unichr>, 'id': <built-in function id>, 'OSError': <type 'exceptions.OSError'>, 'DeprecationWarning': <type 'exceptions.DeprecationWarning'>, 'min': <built-in function min>, 'UnicodeWarning': <type 'exceptions.UnicodeWarning'>, 'execfile': <built-in function execfile>, 'any': <built-in function any>, 'complex': <type 'complex'>, 'bool': <type 'bool'>, 'ValueError': <type 'exceptions.ValueError'>, 'NotImplemented': NotImplemented, 'map': <built-in function map>, 'buffer': <type 'buffer'>, 'max': <built-in function max>, 'object': <type 'object'>, 'TabError': <type 'exceptions.TabError'>, 'callable': <built-in function callable>, 'ZeroDivisionError': <type 'exceptions.ZeroDivisionError'>, 'eval': <built-in function eval>, '__debug__': True, 'IndentationError': <type 'exceptions.IndentationError'>, 'AssertionError': <type 'exceptions.AssertionError'>, 'classmethod': <type 'classmethod'>, 'UnboundLocalError': <type 'exceptions.UnboundLocalError'>, 'NotImplementedError': <type 'exceptions.NotImplementedError'>, 'AttributeError': <type 'exceptions.AttributeError'>, 'OverflowError': <type 'exceptions.OverflowError'>, 'WindowsError': <type 'exceptions.WindowsError'>}, 'MAnimCurveChange': <type 'OpenMayaAnim.MAnimCurveChange'>, '__file__': 'C:\\Program Files\\Autodesk\\Maya2016\\Python\\lib\\site-packages\\maya\\api\\OpenMayaAnim.pyc', 'MFnAnimCurve': <type 'OpenMayaAnim.MFnAnimCurve'>, 'MAnimCurveClipboard': <type 'OpenMayaAnim.MAnimCurveClipboard'>, 'MAnimCurveClipboardItem': <type 'OpenMayaAnim.MAnimCurveClipboardItem'>, 'py2dict': {'MAnimCurveClipboardItemArray': <type 'OpenMaya.MAnimCurveClipboardItemArray'>, 'MAnimMessage': <type 'OpenMayaAnim.MAnimMessage'>, 'MFnSkinCluster': <type 'OpenMayaAnim.MFnSkinCluster'>, 'MFnAnimCurve': <type 'OpenMayaAnim.MFnAnimCurve'>, '__file__': 'C:\\Program Files\\Autodesk\\Maya2016\\Python\\lib\\site-packages\\maya\\api\\_OpenMayaAnim_py2.pyd', 'MAnimCurveChange': <type 'OpenMayaAnim.MAnimCurveChange'>, 'MAnimCurveClipboard': <type 'OpenMayaAnim.MAnimCurveClipboard'>, 'MAnimCurveClipboardItem': <type 'OpenMayaAnim.MAnimCurveClipboardItem'>, '__doc__': 'OpenMayaAnim API.', 'MFnGeometryFilter': <type 'OpenMayaAnim.MFnGeometryFilter'>, 'MAnimUtil': <type 'OpenMayaAnim.MAnimUtil'>, '__name__': 'maya.api._OpenMayaAnim_py2', '__package__': None, 'MAnimControl': <type 'OpenMayaAnim.MAnimControl'>}, '__package__': 'maya.api', 'MFnGeometryFilter': <type 'OpenMayaAnim.MFnGeometryFilter'>, 'MAnimControl': <type 'OpenMayaAnim.MAnimControl'>, 'key': 'MAnimControl', 'MAnimUtil': <type 'OpenMayaAnim.MAnimUtil'>, '__name__': 'maya.api.OpenMayaAnim', '__doc__': None}    py2dict = {'MAnimCurveClipboardItemArray': <type 'OpenMaya.MAnimCurveClipboardItemArray'>, 'MAnimMessage': <type 'OpenMayaAnim.MAnimMessage'>, 'MFnSkinCluster': <type 'OpenMayaAnim.MFnSkinCluster'>, 'MFnAnimCurve': <type 'OpenMayaAnim.MFnAnimCurve'>, '__file__': 'C:\\Program Files\\Autodesk\\Maya2016\\Python\\lib\\site-packages\\maya\\api\\_OpenMayaAnim_py2.pyd', 'MAnimCurveChange': <type 'OpenMayaAnim.MAnimCurveChange'>, 'MAnimCurveClipboard': <type 'OpenMayaAnim.MAnimCurveClipboard'>, 'MAnimCurveClipboardItem': <type 'OpenMayaAnim.MAnimCurveClipboardItem'>, '__doc__': 'OpenMayaAnim API.', 'MFnGeometryFilter': <type 'OpenMayaAnim.MFnGeometryFilter'>, 'MAnimUtil': <type 'OpenMayaAnim.MAnimUtil'>, '__name__': 'maya.api._OpenMayaAnim_py2', '__package__': None, 'MAnimControl': <type 'OpenMayaAnim.MAnimControl'>}class val(object):    """    Control over animation playback and values    """    def __init__(self, *args, **kwargs):        """        x.__init__(...) initializes x; see help(type(x)) for signature        """        pass    def animationEndTime(*args, **kwargs):        """        animationEndTime() -> MTime
